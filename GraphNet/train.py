...
siglist = {
    ...
    1:    ('/home/pmasterson/events/v3.0.0_tag_standard_skimmed/signal*0.001*.root', 200000),
    10:   ('/home/pmasterson/events/v3.0.0_tag_standard_skimmed/signal*0.01*.root',  200000),
    100:  ('/home/pmasterson/events/v3.0.0_tag_standard_skimmed/signal*0.1*.root',   200000),
    1000: ('/home/pmasterson/events/v3.0.0_tag_standard_skimmed/signal*1.0*.root',   200000),
    ...
    # }
/home/pmasterson/events/v3.0.0_tag_standard_skimmed/signal
...
if args.demo:
    bkglist = {
        # (filepath, num_events_for_training)
        0: ('/home/pmasterson/events/v3.0.0_tag_standard_skimmed/signal*pn*.root', 800)
        }

    siglist = {
        # (filepath, num_events_for_training)
        1:    ('/home/pmasterson/events/v3.0.0_tag_standard_skimmed/signal*0.001*.root', 200),
        10:   ('/home/pmasterson/events/v3.0.0_tag_standard_skimmed/signal*0.01*.root',  200),
        100:  ('/home/pmasterson/events/v3.0.0_tag_standard_skimmed/signal*0.1*.root',   200),
        1000: ('/home/pmasterson/events/v3.0.0_tag_standard_skimmed/signal*1.0*.root',   200),
        }

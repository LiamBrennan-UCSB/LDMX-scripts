...
cellMap = np.loadtxt('/nfs/slac/g/ldmx/users/aechavez/ldmx-sw-v3.0.0/segmipx_bdt/mods/cellmodule.txt')
...
def event_process(self):
    ...
    # Electron at scoring planes and momentum for pre-selection
    if e_targetHit != None:
        feats['isAtTSP'] = 1
